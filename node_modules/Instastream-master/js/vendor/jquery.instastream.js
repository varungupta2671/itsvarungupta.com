    ...
    $.fn.createStream = function(slide, target) {
        ...
        $.ajax({
            ...
            success: function(data) {
                if ($instaMenu == 'yes') {
                    $(target).append("<div class='slider-menu'><a href='#' class='prev'><i class='ico-prev'></i></a><a href='#' class='next'><i class='ico-next'></i></a></div>");
                }
                ...
                for (var i = 0; i < $nbrResults; i++) {
                    if (j < 20) {
                        ...
                        $('.slider-content').append("<div id='slider-item" + i + "' class='slider-item slider-col" + $nbrResults + "'><div class='frame'><a><img src='" + data.data[j].images.standard_resolution.url + "' alt='" + myCaption + "'><span class='frame-title' style='display: block; bottom: -50px;'><em>" + data.data[j].likes.count + "<i class='ico-like white'>" + likeLabel + "</i> " + data.data[j].comments.count + "<i class='ico-comment white'>" + commentLabel + "</i> " + data.data[j].created_time.timeconverter() + "</em></span><span class='frame-more' style='display: block; top: -38px;'>+</span><span class='frame-reflect'></span></a></div><header><h4>" + myCaption + "</h4></header>");
                        j++;
                        $slideStatus = j;
                    }
                };
